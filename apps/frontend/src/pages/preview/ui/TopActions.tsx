...
function KebabIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path d="M9.99935 10.8327C10.4596 10.8327 10.8327 10.4596 10.8327 9.99935C10.8327 9.53911 10.4596 9.16602 9.99935 9.16602C9.53911 9.16602 9.16602 9.53911 9.16602 9.99935C9.16602 10.4596 9.53911 10.8327 9.99935 10.8327Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M9.99935 16.6667C10.4596 16.6667 10.8327 16.2936 10.8327 15.8333C10.8327 15.3731 10.4596 15 9.99935 15C9.53911 15 9.16602 15.3731 9.16602 15.8333C9.16602 16.2936 9.53911 16.6667 9.99935 16.6667Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M9.99935 4.99967C10.4596 4.99967 10.8327 4.62658 10.8327 4.16634C10.8327 3.7061 10.4596 3.33301 9.99935 3.33301C9.53911 3.33301 9.16602 3.7061 9.16602 4.16634C9.16602 4.62658 9.53911 4.99967 9.99935 4.99967Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
}

export default function TopActions({ isFav, onBack, onToggleFav, onMenu }: Props) {
    return (
        <div className="preview__topbar">
            <button className="icon-btn" onClick={onBack} aria-label="Назад"><BackIcon/></button>
            <div className="spacer" />
            <button className="icon-btn" onClick={onToggleFav} aria-label="В избранное"><StarIcon filled={isFav}/></button>
            <button className="icon-btn" onClick={onMenu} aria-label="Меню"><KebabIcon/></button>
        </div>
    )
}
