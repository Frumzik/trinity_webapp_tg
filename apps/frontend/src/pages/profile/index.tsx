    ...
    return (
        <div className="app">
            ...
            <main className="screen" >
                <Title right={<button className="icon-btn"><img src={EditIcon} alt=""/></button>}>Личный кабинет</Title>
                <ProfileHeader
                ...
                <section className="scrollBox stack">
                    <ScrollPanel maxHeight="57dvh" vars={{
                        railRight: '-15px',
                        railTop: '4px',
                        railBottom: '4px',
                        railWidth: '3px',
                        ...
                        <div className="tiles">
                            ...
                            <GreyTile title="О проекте" imageUrl={Card3} buttonText={'Скачать презентацию'} href="#"/>
                        ...
                        <div className="scrollBox__title-cont">
                            ...
                            <div className="scrollBox__icon"><a href="#"><img src={PopupIcon} alt="help"/></a></div>
                        </div>

                        <ReferralsTile imageUrl={Card4} referrals={[{id: 1}, {id: 2}, {id: 3}, {id: 4}]}
                                       href="/referrals"/>
                        ...
                        <ScrollPanel maxHeight="200px" vars={{
                            railRight: '0px',
                            railTop: '0px',
                            railBottom: '6px',
                            railWidth: '3px',
            ...
            <div className="gbtn-bar">
                <div className="gbtn-bar__inner">
                    <GradientButton href="https://t.me/share/url?url=..." target="_blank">Пригласить
                        друга</GradientButton>
                </div>
            </div>
            <Footer/>
