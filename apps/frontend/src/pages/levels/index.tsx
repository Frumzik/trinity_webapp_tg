...
export default function Index() {
    ...
    const [clickedId, setClickedId] = useState<string | number | undefined>(undefined)
    ...
    const purchase = (_p: { levelIds: (string | number)[]; totalOM: number; discountedOM?: number }) => {
        setModalOpen(false)
    }

    return (
        <div className="app" style={{ ['--gbutton-h' as any]: '60px' }}>
            <TopBar title="Ступени духа" rightIconUrl={helpIcon} onRightClick={() => {}} />
