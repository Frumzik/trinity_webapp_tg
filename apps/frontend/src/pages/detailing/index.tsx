    ...
    return (
        <div className="app" >
            ...
            <main className="screen" >
                <Title right={<button className="icon-btn"></button>} ><div style={{fontSize: "27px"}}>Детализация</div></Title>
            ...
            <div className="gbtn-bar">
                <div className="gbtn-bar__inner">
                    <GradientButton href="https://t.me/share/url?url=..." target="_blank">Пригласительная ссылка</GradientButton>
                </div>
            </div>
            <Footer/>
