            ...
            <main className="screen">
                <div className="supportPage">
                    ...
                    <div className="supportPage__cards">
                        <GreyTile title="О проекте" imageUrl={ChannelImg} buttonText={'Перейти'} href="#" buttonStyle={{ width: '78px' }}/>
                        <GreyTile title="Чат" imageUrl={ChatImg} buttonText={'Перейти'} href="#" buttonStyle={{ width: '78px' }}/>
                        <GreyTile title={<>Связаться<br/>с поддержкой</>} buttonText={'Перейти'} imageUrl={SupportImg}
                                  href="https://t.me/your_support" style={{height:'110px'}} buttonStyle={{ width: '78px' }}/>
                    </div>
                </div>
            </main>
