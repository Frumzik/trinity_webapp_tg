...
const films = [
    {id: 1, title: 'Практики', subtitle: 'Ежедневные', imageUrl: Card5},
        ...
        <div className="app" style={{['--gbutton-h' as any]: '60px'}}>
            ...
            <main className="screen favorites">
                ...
                <div className="promo-container">
                    <PromoTile title={films[0].title} bgSrc={Bgmini} imageUrl={films[0].imageUrl}/>
                    <PromoTile title={films[1].title} bgSrc={Bgmini} imageUrl={films[1].imageUrl}/>
                    <PromoTile title={films[2].title} bgSrc={Bgmini} imageUrl={films[2].imageUrl}/>
                </div>
            </main>
