...

          {
            ...
            children: [
              ...
              { path: 'workshop', element: wrap(<WorkshopPage />) },
              {
                ...
                children: [
                  {
                    element: wrap(<StoreLayout variant="root" />),
                    children: [{ index: true, element: <StorePage /> }],
                  },
                  {
                    path: ":kind",
                    element: wrap(<StoreLayout variant="deep" />),
                    children: [
                      { index: true, element: <StoreNode /> },
                      { path: "*", element: <StoreNode /> },
                      { path: "*/contact", element: <StoreContact /> },
                    ],
                  },
                ],
              },
              {
                path: "store-preview/:trainingId",
                element: wrap(<StorePreviewPage />),
              },
              ...
              {
                path: 'security/reset-pin-request',
                element: wrap(<ResetPinRequestPage />),
              },
              {
                path: 'security/reset-pin-confirm',
                element: wrap(<ResetPinConfirmPage />),
              },
              ...
              {
                path: 'lesson/:trainingId/:lessonId',
                element: wrap(<LessonTextPage />),
              },
              ...
              { path: 'progress', element: wrap(<ProgressPage />) },
              {
                ...
                element: wrap(<TrainingLevelsIndex />),
              },
