    ...
    >
      ...
      <div className="levelCard__panel">
        ...
        <div className="levelCard__box">
          <div className="levelCard__subtitle">
            Прогресс
            <br />
            до следующего
          </div>
          <div className="levelCard__scale">
            <div className="levelCard__scale-container">
              <span className="levelCard__mark levelCard__mark--active">
                {level}
              </span>
              <span className="levelCard__mark levelCard__mark--muted">
                {next}
              </span>
            </div>
