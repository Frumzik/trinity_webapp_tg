    ...
    <div>
      <div className="wform">
        ...
        <div className="wform__chips">
          <div className="wform__chip">ДОСТУПНЫЙ БАЛАНС: {balance ?? 0} OM</div>
        ...
        <div className="wform__agree">
          Нажимая кнопку «ПОЛУЧИТЬ USDT»,
          <br />
          я подтверждаю, что ознакомился
          <br />с <Link to="/policy">Правилами сервиса</Link>
        </div>

        <div className="wform__info"></div>
      </div>
