  ...
  return (
    <div className="app">
      ...
      <main className="screen" style={{ marginTop: 36 }}>
        ...
        >
          <div style={{ fontSize: '27px' }}>Резервный Фонд</div>
        </Title>
      <section className="two-block">
        <div className="two-block__wrapper">
          <div className="two-block__text">
            <p>Упущенные вознаграждения с момента поступления в Резервный Фонд хранятся 9 дней и при невыполнении условий автоматически отправляются в Фонд ТРИНИТИ</p>
          </div>
          <div className="two-block__count">
